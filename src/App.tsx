...
export type TabType = 'dashboard' | 'upload' | 'youtube' | 'lessons' | 'quiz' | 'flashcards' | 'chat' | 'investors' | 'settings' | 'ai-coach' | 'study-timer' | 'image-recognition' | 'notes' | 'tasks' | 'habits' | 'credits';
