        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-secondary/10 text-secondary ring-1 ring-secondary/30">
              <Sparkles className="w-4 h-4" /> Aurora light + dark styling
            </span>
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-accent/10 text-accent ring-1 ring-accent/30">
              Curated gradients, glass, and glow
            </span>
          </div>
          <div className="flex flex-col gap-3">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
              SlideTutor OS for modern learners
            </h1>
            <p className="text-lg text-muted-foreground max-w-3xl">
              A prismatic indigo + mint system tuned for clarity in both modes, pairing premium surfaces with AI-first flows so you can upload, learn, quiz, and revise without friction.
            </p>
          </div>
